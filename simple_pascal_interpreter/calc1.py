...
class Token(object):
    def __init__(self, type, value):
        # token type: INTEGER, PLUS, SUBTRACT or EOF
        self.type = type
...
class Interpreter(object):
    ...
    def get_next_token(self):
        ...
        apart into tokensl. One token at a time.
        """
        text = self.text.replace(' ','') # remove spaces
        ...
        # integer, create an INTEGER token, self.pos
        # index to point to the next character after the digit,
        # and return the INTEGER token

        # modified, could allow multiple-digit integers
